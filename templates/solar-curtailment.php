<?php 
    ...
    /* Template Name: solar-curtailment-temp*/
    get_header();
?>
                ...
                <div class="container">
                    ...
                    <?php if ( $hvac_heading = get_field( 'hvac_heading' ) ) : ?>
                        ...
                        <ul class="breadcrumb" id="slash">
                            ...
                            <li class="breadcrumb-item"> Solar Curtailment & Shunt Trip Protection</li>
                        </ul>
                    </div>
                </div>
            </section>
            ...
            <section id="case-trust">
                <div class="container">
                    <div class="solar-trust-content">
                        ...
                        <div class="major-client ncs-logo">
