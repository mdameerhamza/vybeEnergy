...
<section id="blog-page-banner" style="background-image: url(images/approach-blog-banner.png);">
	...
	<div class="container">
		<div class="blog-banner-content">
			...
			<ul class="breadcrumb" id="slash">
				...
				<li class="breadcrumb-item"><a href="<?php echo esc_url(home_url()); ?>/latest-resources/"> Latest Resources</a></li>
...
<section id="approch-blog">
	<div class="blog-container">
		<div class="apprch-blog-content">
			<div class="blog-span">
				<span class="heading-2"><?php echo get_the_date();?></span>
			</div>
...
<section id="blog-resource">
	<div class="container">
		<div class="blog-latest-text">
			<span class="heading-1">Resources</span>
			<h2 class="latest-head">Related Resources</h2>
		</div>
	</div>
	<div class="resources-content">
		<div class="container">
		<div class="latest-content-news-page">
               <?php $args = array( 'post_type' => 'post', 'posts_per_page' => 3, 'order' => 'ASC' ); $the_query = new WP_Query( $args ); ?>
