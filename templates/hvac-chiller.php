<?php 
    ...
    /* Template Name: hvac-chiller-temp*/
    get_header();
?>
                ...
                <div class="container">
                    ...
                    <div class="news-banner-content">
                        ...
                        <ul class="breadcrumb" id="slash">
                            ...
                            <li class="breadcrumb-item"> HVAC/Chiller Plant Control</li>
                        </ul>
                    </div>
                </div>
            </section>
                        ...
                        <div class="double-tick">
                            ...
                            <div class="tick">
                                ...
                                <?php if ( $features_list = get_sub_field( 'features_list' ) ) : ?>
                                    <p class="tick-text"><?php echo esc_html( $features_list ); ?></p>
                                <?php endif; ?>
                            </div>
                            <?php endwhile; endif; ?>
                        </div>
            ...
            <section id="case-trust">
                <div class="container">
                    <div class="case-trust-content">
                        <div class="case-trust-text">
